<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\brand\brand.html";i:1514360120;}*/ ?>
...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="<?php echo url('index/brand/brandadd'); ?>">上传广告&nbsp;&nbsp;+</a>
				</div>
				<!-- banner 表格 显示 -->
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>是</td>
							<td>1</td>
							<td><a href="<?php echo url('index/brand/brandupdate'); ?>"><img class="operation"
						...
						<tr>
							...
							<td>是</td>
							<td>1</td>
							<td><a href="brandadd.html"><img class="operation"
									src="__IMG__update.png"></a> <img class="operation delban"
								src="__IMG__delete.png"></td>
						</tr>
					</table>
