<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"F:\phpstudy\WWW\mall\admin\public/../application/index\view\brand\banner.html";i:1514359281;}*/ ?>
...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="<?php echo url('index/brand/banneradd'); ?>">上传广告&nbsp;&nbsp;+</a>
				</div>
				<!-- banner 表格 显示 -->
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>是</td>
							<td>1</td>
							<td><a href="<?php echo url('index/brand/bannerupdate'); ?>"><img class="operation"
