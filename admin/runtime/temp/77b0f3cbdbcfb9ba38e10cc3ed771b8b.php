<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\system\changepwd.html";i:1514862121;}*/ ?>
			...
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						...
						src="__IMG__ok.png" /><img class="imgb" src="__IMG__no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="__IMG__ok.png" /><img
						class="imgb" src="__IMG__no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
