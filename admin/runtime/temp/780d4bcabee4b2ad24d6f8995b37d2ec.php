<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\logistics\product_category.html";i:1514870023;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li><a href="product.html"><i class="product"></i><em>分类列表</em></a></li>
 </ul>
  <ul>
  <li><a href="product_category.html"><i class="productCat"></i><em>商品属性</em></a></li>
  <li><a href="product.html"><i class="product"></i><em>属性列表</em></a></li>
 </ul>
  <ul>
  <li><a href="product_category.html"><i class="productCat"></i><em>商品品牌</em></a></li>
  <li><a href="product.html"><i class="product"></i><em>品牌列表</em></a></li>
 </ul>
   <ul class="bot">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>属性管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="add_product_category.html" class="actionBtn add">添加属性</a>品牌属性</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        <th width="120" align="left">属性名称</th>
        <th align="left">别名</th>
...
<div id="dcFooter">
 <div id="footer">
  <div class="line"></div>
  <ul>
   版权所有 © 2017-2012 速Go网络科技有限公司，并保留所有权利。
  </ul>
 </div>
</div><!-- dcFooter 结束 -->
