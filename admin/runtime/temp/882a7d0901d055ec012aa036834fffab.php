<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\category\product_category.html";i:1514873945;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>分类管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="add_product_category.html" class="actionBtn add">添加分类</a>分类管理</h3>
