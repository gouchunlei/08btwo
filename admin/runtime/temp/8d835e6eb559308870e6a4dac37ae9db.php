<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\vip\manager_log.html";i:1514872037;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li><a href="<?php echo url('index/attr/index'); ?>"><i class="product"></i><em>属性列表</em></a></li>
 </ul>
  <ul>
  <li><a href="<?php echo url('index/brand/index'); ?>"><i class="productCat"></i><em>商品品牌</em></a></li>
  <li><a href="<?php echo url('index/brand/index'); ?>"><i class="product"></i><em>品牌列表</em></a></li>
 </ul>
 <ul>
 ...
 <ul>
  ...
  <li><a href="<?php echo url('index/order/index'); ?>"><i class="product"></i><em>订单列表</em></a></li>
 </ul>
 <ul>
  <li><a href="<?php echo url('index/logistics/index'); ?>"><i class="productCat"></i><em>物流管理</em></a></li>
  <li><a href="<?php echo url('index/logistics/index'); ?>"><i class="product"></i><em>物流列表</em></a></li>
 </ul>
 <ul>
  <li><a href="<?php echo url('index/trading/index'); ?>"><i class="productCat"></i><em>交易管理</em></a></li>
  <li><a href="<?php echo url('index/trading/index'); ?>"><i class="product"></i><em>交易列表</em></a></li>
 </ul>
 <ul>
  <li><a href="<?php echo url('index/pay/index'); ?>"><i class="productCat"></i><em>支付管理</em></a></li>
  <li><a href="<?php echo url('index/pay/index'); ?>"><i class="product"></i><em>支付列表</em></a></li>
 </ul>
 <ul>
  <li><a href="<?php echo url('index/money/index'); ?>"><i class="productCat"></i><em>平台资金管理</em></a></li>
  <li><a href="<?php echo url('index/money/index'); ?>"><i class="product"></i><em>平台资金列表</em></a></li>
 </ul>
 <ul>
  <li><a href="<?php echo url('index/marketing/index'); ?>"><i class="productCat"></i><em>营销管理</em></a></li>
  <li><a href="<?php echo url('index/marketing/index'); ?>"><i class="product"></i><em>营销列表</em></a></li>
 </ul>
  <ul>
  <li><a href="<?php echo url('index/talk/index'); ?>"><i class="productCat"></i><em>营销管理</em></a></li>
  <li><a href="<?php echo url('index/talk/index'); ?>"><i class="product"></i><em>营销列表</em></a></li>
 </ul>
   <ul class="bot">
