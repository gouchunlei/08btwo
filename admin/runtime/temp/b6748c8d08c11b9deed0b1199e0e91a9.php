<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"F:\phpstudy\WWW\sugoo\admin\public/../application/index\view\brand\product_category.html";i:1514873914;}*/ ?>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>品牌管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="add_product_category.html" class="actionBtn add">添加品牌</a>品牌管理</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        <th width="120" align="left">品牌名称</th>
        <th align="left">别名</th>
