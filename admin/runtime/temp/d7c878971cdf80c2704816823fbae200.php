<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy\WWW\sugoo\admin\public/../application/index\view\vip\vip.html";i:1514372574;}*/ ?>
...
<link rel="stylesheet" type="text/css" href="__CSS__/manhuaDate.1.0.css">
	<script type="text/javascript" src="__JS__jquery.min.js"></script>
	<script type="text/javascript" src="__JS__manhuaDate.1.0.js"></script>
	<script type="text/javascript" src="__JS__jquery-1.7.2.min.js"></script>
				...
				<div class="conform">
					<form>
						...
						<div class="cfD">
							...
							<a class="addA addA1" href="<?php echo url('index/vip/vipadd'); ?>">新增会员+</a> <a
								class="addA addA1 addA2" href="<?php echo url('index/vip/vipreset'); ?>">密码重置</a>
						</div>
					</form>
				</div>
				<!-- vip 表格 显示 -->
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td>0.00<input class="vipinput" type="text" /><a
								class="vsAdd">增加</a></td>
							<td>总监</td>
							<td><a href="<?php echo url('index/vip/vipadd2'); ?>"><img class="operation"
