<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\phpstudy\WWW\git\public/../application/index\view\infor\infor.html";i:1512126807;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="__JS__/column.js"></script>
</head>
<body>
<!--浮动-->
...
<div class="main">
  ...
  <div class="con-circle">
    <aside class="sec_ce">
      ...
      <img src="__Iages__/zhuti.png" alt="">
...
<!-- 页面底部 -->
<div class="btn-invest"><a class="fsize" href="infor4.html" style="display: block;">快速登录</a></div>
</body>
</html>
