<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"F:\phpstudy\WWW\git\p2p\public/../application/index\view\index\index.html";i:1512174372;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="__CSS__/idangerous.swiper.css" />
...
<div class="dropBox">
  ...
  <ul class="dropList">
    ...
    <li class="nth-child_4"> <a href="index.php/index/register/index" class="dropIco"></a>
      <p>注册</p>
    </li>
...
<!-- 页面头部 -->
<header class="header"><a href="#" class="logo"><img src="__Iages__/logo.png"></a><a href="#" class="topleft" id="allmm"><i><img src="__Iages__/add.png" width="13"></i>&nbsp;
  <e>合肥</e>
  </a>
  <!-- 登录和未登录 -->
  <div class="nav-top-bar" onClick="$(this).next().stop().slideToggle(200,'easeOutQuad')"></div>
  <div class="header-nav"> <a href="index.php/index/register/index"> <img src="__Iages__/register.png" /> 注册 </a> <a href="index.php/index/login/index"> <img src="__Iages__/login.png" /> 登录 </a> <a href="index.php/index/invest/index"> <img src="__Iages__/invest.png" /> 投资 </a> </div>
</header>
<!-- 中间内容 -->
<div class="main">
  <!-- Banner -->
  <div class="swiper-container">
    <div class="swiper-wrapper" style="width: 2560px; height: 75px; -webkit-transform: translate3d(-1920px, 0px, 0px); transition: 0.3s; -webkit-transition: 0.3s;"><a class="swiper-slide swiper-slide-duplicate" href="#" target="_blank" style="width: 640px; height: 75px;"><img src="__Iages__/banner.png" height="75"></a> <a class="swiper-slide" href="#" target="_blank" style="width: 640px; height: 75px;"><img src="__Iages__/banner.png" height="75"></a> <a class="swiper-slide" href="#" target="_blank" style="width: 640px; height: 75px;"><img src="__Iages__/banner.png" height="75"></a> <a class="swiper-slide swiper-slide-duplicate swiper-slide-visible swiper-slide-active" href="#" target="_blank" style="width: 640px; height: 75px;"><img src="__Iages__/banner.png" height="75"></a></div>
  ...
  <div class="wgt-login"> <a class="btn btn-regist" href="index.php/index/invest/index">立即投资</a> <a class="btn btn-login" href="index.php/index/myself/index">我的账户</a> </div>
  <div class="clear"></div>
