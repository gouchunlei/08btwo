<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\phpstudy\WWW\git\public/../application/index\view\login\login.html";i:1512176762;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="page-main">
      <form action="" method="post" id="user-login-form" accept-charset="UTF-8" class="reg-form">
        ...
        <div class="remember">
          ...
          <span>记住用户名</span><a href="forget">忘记密码?</a> </div>
