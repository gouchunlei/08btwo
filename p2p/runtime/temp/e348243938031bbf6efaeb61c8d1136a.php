<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\phpstudy\WWW\git\public/../application/index\view\register\register.html";i:1512131502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="register">
  <div class="wrapper-reg">
    <div class="page-header"> <a href="/"> <img src="__Iages__/reg-logo.png"> </a> </div>
    <div class="page-main">
      <form id="registerForm" name="registerForm" method="post" action="#" class="reg-form" enctype="application/x-www-form-urlencoded">
        ...
        <div class="m-field m-yzm" id="imageCode" >
          ...
          <span class="c-yzm"><img style="height: 100%;" src="__Iages__/code.jpg"></span>
        ...
        <div class="agreement"> 我已阅读并同意阳光易贷的<a href="useragree" class="reg-xy">《隐私条款》</a>和 <a href="useragree1" class="reg-xy">《服务条款》</a> </div>
...
<div id="allmenu" style="display:none;">
  <div class="pt45" style="margin-top: 0px;">
    <div class="cityadd" style="position:relative"> <i><img src="__Iages__/addr.png" width="100%"></i><a href="/nj.html">南京</a> <a href="javascript:void(0)" onClick="closeDiv('allmenu')" style=" position:absolute; right:5px; top:15px;"><img src="__Iages__/xxx.png" width="18" height="18"></a></div>
...
<script type="text/javascript" src="__JS__/jsf.js.htm"></script>
</body>
</html>
